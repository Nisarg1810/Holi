...
export const metadata: Metadata = {
  ...
  keywords: "helicopter booking, private charter fly, luxury tourism India, helicopter tour package, private yacht rental, Private aviation travel, Roman Aviation",
};
    ...
    >
      <body className="min-h-full flex flex-col bg-background text-foreground selection:bg-gold/30 selection:text-white font-sans overflow-x-hidden">
        ...
        <a
          ...
          title="Chat with Flight Concierge"
        >
